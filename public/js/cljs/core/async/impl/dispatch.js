...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18667 = 0;while(true){
var m_18668 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18668 == null))
{} else
{m_18668.call(null);
if((count_18667 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18669 = (count_18667 + 1);
count_18667 = G__18669;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3387__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3387__auto__)
