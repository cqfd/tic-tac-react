...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18673 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18673 = (function (val,box,meta18674){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18673.cljs$lang$type = true;
cljs.core.async.impl.channels.t18673.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18673";
cljs.core.async.impl.channels.t18673.cljs$lang$ctorPrWriter = (function (this__3948__auto__,writer__3949__auto__,opt__3950__auto__){return cljs.core._write.call(null,writer__3949__auto__,"cljs.core.async.impl.channels/t18673");
});
cljs.core.async.impl.channels.t18673.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18673.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18675){var self__ = this;
var _18675__$1 = this;return self__.meta18674;
});
cljs.core.async.impl.channels.t18673.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18675,meta18674__$1){var self__ = this;
var _18675__$1 = this;return (new cljs.core.async.impl.channels.t18673(self__.val,self__.box,meta18674__$1));
});
cljs.core.async.impl.channels.__GT_t18673 = (function __GT_t18673(val__$1,box__$1,meta18674){return (new cljs.core.async.impl.channels.t18673(val__$1,box__$1,meta18674));
});
}
return (new cljs.core.async.impl.channels.t18673(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3951__auto__,writer__3952__auto__,opts__3953__auto__){return cljs.core._write.call(null,writer__3952__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3948__auto__,writer__3949__auto__,opt__3950__auto__){return cljs.core._write.call(null,writer__3949__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_18676 = self__.takes.pop();if((taker_18676 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18676))
{var take_cb_18677 = cljs.core.async.impl.protocols.commit.call(null,taker_18676);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18677,taker_18676){
return (function (){return take_cb_18677.call(null,null);
});})(take_cb_18677,taker_18676))
);
} else
{}
{
