...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3948__auto__,writer__3949__auto__,opt__3950__auto__){return cljs.core._write.call(null,writer__3949__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_18632 = 0;while(true){
if((i_18632 < arr.length))
{(arr[i_18632] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3948__auto__,writer__3949__auto__,opt__3950__auto__){return cljs.core._write.call(null,writer__3949__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_18639 = (self__.level + 1);while(true){
if((i_18639 <= (new_level + 1)))
{(update[i_18639] = self__.header);
{
var G__18640 = (i_18639 + 1);
i_18639 = G__18640;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_18641 = 0;while(true){
if((i_18641 <= self__.level))
{var links_18642 = (update[i_18641]).forward;if(((links_18642[i_18641]) === x__$1))
{(links_18642[i_18641] = (x__$1.forward[i_18641]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3399__auto__ = (cljs.core.truth_((function (){var and__3387__auto__ = me;if(cljs.core.truth_(and__3387__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3387__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3399__auto__))
